...
if __name__ == "__main__":
    ...
    while True:
        ...
        if reward is not None:
            ...
            print("%d: done %d games, reward %.3f, beta %.2f, speed %.2f f/s"%(frame_idx, len(total_reward), m_reward, buffer.beta, speed))
            ...
            if best_m_reward is None or best_m_reward < m_reward:
                torch.save(net.state_dict(), params.env_name + "-rainbow-best_%.0f.dat"%m_reward)
