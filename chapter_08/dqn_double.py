    ...
    while True:
        ...
        if reward is not None:
            ...
            if best_m_reward is None or best_m_reward < m_reward:
                torch.save(net.state_dict(), params.env_name + "-double-best_%.0f.dat"%m_reward)
        ...
        loss_t = calc_double_dqn_loss(batch, agent.dqn_model, tgt_net.target_model, gamma, device)
        loss_t.backward()
        optimizer.step()
