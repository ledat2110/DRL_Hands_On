...
if __name__ == "__main__":
    writer = SummaryWriter(comment='-carpole-ga')
    ...
    while True:
        ...
        writer.add_scalar("mean_reward", reward_mean, gen_idx)
        writer.add_scalar("max_reward", reward_max, gen_idx)
        writer.add_scalar("std_reward", reward_std, gen_idx)
